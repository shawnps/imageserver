// Package groupcache provides a imageserver.Server implementation that uses groupcache.
package groupcache
...
// Server is a imageserver.Server implementation that uses groupcache.
//
